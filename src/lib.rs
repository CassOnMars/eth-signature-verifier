use {
    alloy_primitives::{keccak256, Address, Bytes, FixedBytes, TxKind, B256, U256},
    alloy_provider::Provider,
    alloy_rpc_types::{TransactionInput, TransactionRequest},
    alloy_signer::k256::ecdsa::{RecoveryId, Signature, VerifyingKey},
    alloy_sol_types::{sol, SolCall, SolConstructor},
...
mod test {
    ...
    async fn erc6492_deployed_smart_wallet() {
        ...
        let signature:Bytes = alloy_primitives::hex::decode("").unwrap().into();
    ...
    async fn erc6492_deployed_smart_wallet_part_2() {
        ...
        let message = "Example Message";
        let hash_message: FixedBytes<32> = eip191_hash_message(message.as_bytes());
        let signature:Bytes = alloy_primitives::hex::decode("").unwrap().into();
...
- https://royal.io/legal/tos"#;
        let hash_message: FixedBytes<32> = eip191_hash_message(message.as_bytes());
        let signature:Bytes = alloy_primitives::hex::decode("").unwrap().into();
